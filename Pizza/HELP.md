...
* The following dependencies are not known to work with Spring Native: 'Spring Boot DevTools, Spring Configuration Processor, Liquibase Migration'. As a result, your application may not work as expected.
...
```
$ docker run --rm Pizza:0.0.1-SNAPSHOT
```
